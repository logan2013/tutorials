...
import {TzbNgbActiveModal, NgbModalRef} from './modal-ref';
...
export class NgbModalStack {
  ...
  open(moduleCFR: ComponentFactoryResolver, contentInjector: Injector, content: any, options): NgbModalRef {
    ...
    const activeModal = new TzbNgbActiveModal();
  ...
  private _getContentRef(
      ...
      context: TzbNgbActiveModal): ContentRef {
    if (!content) {
      ...
      const modalContentInjector =
          ReflectiveInjector.resolveAndCreate([{provide: TzbNgbActiveModal, useValue: context}], contentInjector);
