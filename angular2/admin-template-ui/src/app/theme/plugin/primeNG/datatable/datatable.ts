import {
    ...
    ChangeDetectorRef, Inject, forwardRef, ViewEncapsulation
} from '@angular/core';
...
@Component({
    ...
    template: `
        <ng-template ngFor let-rowData [ngForOf]="dt.dataToRender" let-even="even" let-odd="odd" let-rowIndex="index">
            <tr #rowGroupElement class="ui-widget-header ui-rowgroup-header text-center" 
            ...
            <tr class="text-center" #rowElement *ngIf="!dt.expandableRowGroups||dt.isRowGroupExpanded(rowData)" [class]="dt.getRowStyleClass(rowData,rowIndex)"
        ...
        <tr *ngIf="dt.isEmpty()" class="ui-widget-content text-center">
            ...
            <ng-template [ngIf]="scrollable">
                <div class="ui-datatable-scrollable-wrapper ui-helper-clearfix" [ngClass]="{'max-height':scrollHeight}">
                    <div *ngIf="frozenColumns" [pScrollableView]="frozenColumns" frozen="true" 
                        [ngStyle]="{'width':frozenWidth}" class="ui-datatable-scrollable-view ui-datatable-frozen-view"></div>
