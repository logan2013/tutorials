...
@Component({
    ...
    template:  `
        <span [ngClass]="{'ui-calendar ui-corner-all ':true,'ui-calendar-w-btn':showIcon}" [ngStyle]="style" [class]="styleClass">
            <ng-template [ngIf]="!inline">
                <input #inputfield type="text" [attr.id]="inputId" [attr.required]="required" [value]="inputFieldValue" (focus)="onInputFocus(inputfield, $event)" (keydown)="onInputKeydown($event)" (click)="closeOverlay=false" (blur)="onInputBlur($event)"
                    ...
                    [ngClass]="'ui-inputtext ui-widget ui-state-default ui-corner-all d-inline-block pull-left col-lg-9 col-md-8  col-sm-8 from-control d-inline'"
                    >
              <div  (click)="onButtonClick($event,inputfield)" class="ui-icon-box  pull-left  p-0 col-lg-3 col-md-4 col-sm-4 text-center d-inline"><span class=" ui-button-icon-left ui-c fa fa-fw fa-calendar ui-icon-d"></span></div>
            ...
            <div #datepicker class="ui-datepicker ui-widget ui-widget-content ui-helper-clearfix ui-corner-all p-0 m-0" [ngClass]="{'ui-datepicker-inline':inline,'ui-shadow':!inline,'ui-state-disabled':disabled,'ui-datepicker-timeonly':timeOnly}" 
                ...
                <table class="ui-datepicker-calendar m-0 text-center" cellpadding="0" cellspacing="0" *ngIf="!timeOnly && (overlayVisible || inline)">
                    <thead>
                        <tr>
                    ...
                    <tbody>
                        <tr *ngFor="let week of dates">
                            <td *ngFor="let date of week" [ngClass]="{'ui-datepicker-other-month ui-state-disabled':date.otherMonth,
                                ...
                                <a class="ui-state-default text-center" href="#" *ngIf="date.otherMonth ? showOtherMonths : true" 
