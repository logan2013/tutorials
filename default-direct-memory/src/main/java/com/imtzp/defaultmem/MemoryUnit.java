...
public enum MemoryUnit {
	...
	/**
	 * Returns the number of kilobytes corresponding to the provided input for a
	 * particular unit of memory.
	 *
	 * @param input
	 *            Number of units of memory.
	...
	/**
	 * Returns the number of megabytes corresponding to the provided input for a
	 * particular unit of memory.
	 *
	 * @param input
	 *            Number of units of memory.
	...
	/**
	 * Returns the number of gigabytes corresponding to the provided input for a
	 * particular unit of memory.
	 *
	 * @param input
	 *            Number of units of memory.
